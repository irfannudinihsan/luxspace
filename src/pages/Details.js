    ...
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
          ...
          <div className="slider">
            <div className="thumbnail">
              {Array(5)
                ...
                .map((_, index) => {
                  return (
                    <div className="px-px-4 relative card group" key={index}>
                      <div
                        className="rounded-xl item bg-gray-300 animate-pulse"
                        style={{ width: 106, height: 106 }}></div>
                    </div>
                  );
                })}
            </div>
        ...
        <div className="flex-1 px-4 md:p-6">
          ...
          <div className="w-366 h-4 mt-6 bg-gray-300 animate-pulse rounded-full"></div>
